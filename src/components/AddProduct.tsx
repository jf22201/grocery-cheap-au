"use client";
import { ButtonHTMLAttributes, SetStateAction, useState, Dispatch } from "react";
...
import {
 ...
 export default function AddProduct({openTrigger, setOpenTrigger}:{openTrigger:boolean,setOpenTrigger:Dispatch<SetStateAction<boolean>>}) {
